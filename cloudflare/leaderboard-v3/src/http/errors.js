...
export function errorFromCause(cause) {
  ...
  if (
    /^(FATAL_|STARTING_RELIC_|RELIC_|META_TRANSACTION_|MERCHANT_|FORGE_|CROSSROADS_|CAMP_|PACT_|ROOM_CHECKPOINT_|PUBLIC_|NORMAL_EXTRACTION_|EXTRACTION_)/u.test(code)
  ) {
