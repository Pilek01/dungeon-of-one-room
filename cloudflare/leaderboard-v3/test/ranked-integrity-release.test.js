...
import {
  ...
  V08_META_1_ROOM_NAVIGATION_PREVIOUS_PRODUCTION_RELEASE_DESCRIPTOR,
  ...
  V08_META_1_MERCHANT_DEPTH_PREVIOUS_PRODUCTION_RELEASE_DESCRIPTOR,
  V08_META_1_MOBILE_HD2_PREVIOUS_PRODUCTION_RELEASE_DESCRIPTOR,
...
const PREVIOUS_ROOM_NAVIGATION_HASH =
  "sha256:eaa89c2568870852173c67cfd601ddd32b649322b3d4bf3b66a2114621a6998a";
const PREVIOUS_ROOM_ELITE_BUDGET_HASH =
...
test("bounded combat resources remain active when the candidate is promoted", () => {
  ...
  assert.deepEqual(
    ...
    V08_META_1_ROOM_NAVIGATION_PREVIOUS_PRODUCTION_RELEASE_DESCRIPTOR.capabilities
  );
  ...
  assert.deepEqual(protocol.BOUNDED_COMBAT_RESOURCES_RULESET_HASHES, [
    ...
    V08_META_1_MOBILE_HD2_PREVIOUS_PRODUCTION_RELEASE_DESCRIPTOR.rulesetHash,
    V08_META_1_SPECIAL_ROOM_ROTATION_PREVIOUS_PRODUCTION_RELEASE_DESCRIPTOR.rulesetHash,
    V08_META_1_OBSERVER_PROFILE_PREVIOUS_PRODUCTION_RELEASE_DESCRIPTOR.rulesetHash,
    V08_META_1_SHRINE_ELITE_BUDGET_PREVIOUS_PRODUCTION_RELEASE_DESCRIPTOR.rulesetHash,
