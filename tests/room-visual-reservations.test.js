...
test("boss and vault seals plus perspective edges reserve their complete HD footprints", () => {
  const boss = {
    roomType: "boss",
    bossRoom: true,
    floorPattern: torchPattern(),
  ...
  assert.equal(boss.floorPattern[1][4], 0, "north perspective edge");
  assert.equal(boss.floorPattern[7][4], 0, "south perspective edge");
