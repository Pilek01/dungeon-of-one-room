...
const outputRoot = path.resolve(process.argv[3] || "output/room-object-guardian-qa");
const scenarios = [
  "descent_hd",
  "corruption_shrine_hd",
  "abyss_pact_hd",
  "vault_guardian_hd"
];
...
if (diagnostics.length > 0) throw new Error(`Room-object/Guardian QA diagnostics: ${JSON.stringify(diagnostics)}`);
console.log(`Captured ${scenarios.length} HD room-object/Guardian scenarios under ${outputRoot}`);
