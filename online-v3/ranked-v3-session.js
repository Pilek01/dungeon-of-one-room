(function exposeRankedV3Session(root, factory) {
  ...
  const TRANSITIONS = Object.freeze({
    ...
    ROOM_ACTIVE: ["RESOLVING_ROOM", "AWAITING_REWARD_OR_TRANSACTION", "TERMINAL_PENDING"],
    RESOLVING_ROOM: ["ROOM_ACTIVE", "AWAITING_REWARD_OR_TRANSACTION", "ENTERING_NEXT_ROOM", "TERMINAL_PENDING", "RETRYING", "RECONNECT_REQUIRED"],
