(function exposeRankedV3Session(root, factory) {
  ...
  const TRANSITIONS = Object.freeze({
    ...
    STARTING_RUN: ["AWAITING_STARTING_RELIC", "RETRYING", "RECONNECT_REQUIRED", "UNRECOVERABLE_PROTOCOL_ERROR"],
    AWAITING_STARTING_RELIC: ["ENTERING_ROOM", "RETRYING", "RECONNECT_REQUIRED", "UNRECOVERABLE_PROTOCOL_ERROR"],
    ENTERING_ROOM: ["ROOM_ACTIVE", "UNRECOVERABLE_PROTOCOL_ERROR"],
    ROOM_ACTIVE: ["RESOLVING_ROOM", "TERMINAL_PENDING"],
    RESOLVING_ROOM: ["AWAITING_REWARD_OR_TRANSACTION", "ENTERING_NEXT_ROOM", "TERMINAL_PENDING", "RETRYING", "RECONNECT_REQUIRED"],
    AWAITING_REWARD_OR_TRANSACTION: ["AWAITING_REWARD_OR_TRANSACTION", "RESOLVING_ROOM", "ENTERING_NEXT_ROOM", "TERMINAL_PENDING", "RETRYING", "RECONNECT_REQUIRED"],
    ENTERING_NEXT_ROOM: ["ROOM_ACTIVE", "UNRECOVERABLE_PROTOCOL_ERROR"],
    TERMINAL_PENDING: ["FINALIZING"],
    FINALIZING: ["FINALIZED", "RETRYING", "RECONNECT_REQUIRED"],
    RETRYING: ["AWAITING_STARTING_RELIC", "ROOM_ACTIVE", "RESOLVING_ROOM", "AWAITING_REWARD_OR_TRANSACTION", "TERMINAL_PENDING", "FINALIZED", "RECONNECT_REQUIRED", "UNRECOVERABLE_PROTOCOL_ERROR"],
    RECONNECT_REQUIRED: ["RETRYING", "ABANDONED_LOCAL_SESSION"],
    UNRECOVERABLE_PROTOCOL_ERROR: ["ABANDONED_LOCAL_SESSION"],
    FINALIZED: [],
